({
    getCreatedRecords: function(cmp, evt){
        ...
        action.setCallback(this, function(res){
            ...
            if(state === 'SUCCESS'){
                ...
                cmp.set("v.TeamMembers",res.teamMembers);
            }
        });
    ...
    saveRecords : function(cmp, evt, help) {
        ...
        action.setParams({
            ...
            "removedMemberIds": cmp.get("v.removedMemberIds")
        });
        action.setCallback(this, function(res){
            var state = res.getState();
            if(state === 'SUCCESS'){
