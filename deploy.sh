...
if [ "$BRANCH" == "master" ]; then
  ...
  while read -r file; do
    echo $file
    sudo cp --parents "$file" /Users/jackbarsotti/pgi_lex/force-app/main/default/diff
    output=sudo cp --parents "$file" /Users/jackbarsotti/pgi_lex/force-app/main/default/diff
    if [[ $output == "cp: failed to get attributes of '$file': No such file or directory" ]]; then
      sudo mkdir $file
      sudo cp "$file" /Users/jackbarsotti/pgi_lex/force-app/main/default/diff
    ...
    if [[ $file == *.cls ]]; then
      find force-app/main/default/classes -samefile "$file-meta.xml" -exec sudo cp --parents -t /Users/jackbarsotti/pgi_lex/force-app/main/default/diff {} +
    elif [[ $file == *.cls-meta.xml ]]; then
      parsedfile=${file%.cls-meta.xml}
      find force-app/main/default/classes -samefile "$parsedfile.cls" -exec sudo cp --parents -t /Users/jackbarsotti/pgi_lex/force-app/main/default/diff {} +
      ...
      find force-app/main/default/triggers -samefile "$file-meta.xml" -exec sudo cp --parents -t /Users/jackbarsotti/pgi_lex/force-app/main/default/diff {} +
  ...
  ls /Users/jackbarsotti/pgi_lex/force-app/main/default/diff/force-app/main/default
fi;